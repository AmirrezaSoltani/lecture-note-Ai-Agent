...
SETTINGS_REGISTRY: tuple[SettingField, ...] = (
    ...
    SettingField("whisper_device", "WHISPER_DEVICE", "Whisper device", "text", "Processing", description="Use auto to prefer GPU and fall back to CPU when CUDA is unavailable.", placeholder="auto"),
...
class Settings:
    ...
    def from_mapping(cls, mapping: Mapping[str, Any]) -> "Settings":
        ...
        return cls(
            ...
            whisper_device=_coerce_text(mapping.get("WHISPER_DEVICE", "auto"), "auto").strip().lower(),
